...
@section('main')
    ...
    2.  วันที่ 17 - 19 พฤษภาคม 2560 จัดการคัดเลือกนักเรียนเข้าชมรมที่ต้องมีการคัดเลือก (ออดิชั่น) โดยนักเรียนจะต้องยืนยันหรือปฏิเสธการเข้าชมรมที่นักเรียนผ่านการคัดเลือกภายในระยะเวลาดังกล่าว มิฉะนั้นระบบอาจยกเลิกสิทธิหรือจัดนักเรียนเข้าชมรมโดยอัตโนมัติ<br />
    3.  วันที่ 21 พฤษภาคม 2560 นักเรียนลงทะเบียนเข้าชมรมที่ไม่ต้องคัดเลือก
    </p>
    ...
    <p>
        ...
        - อนุญาตให้นักเรียนใช้สิทธิเข้าชมรมเดิมได้ไม่เกิน 65% ของจำนวนนักเรียนสูงสุดที่เปิดรับ หากนักเรียนต้องการเข้าชมรมเดิมหลังรับนักเรียนเดิมเต็มขีดจำกัดแล้ว นักเรียนสามารถลงทะเบียนเสมือนไม่ได้อยู่ชมรมเดิมได้<br />
    ...
    <table class="highlight">
        ...
        <tr>
            ...
            <th>ชื่อ</th>
            <th>ประเภท</th>
            <th>จำนวนสมาชิก / จำนวนรับ (ม.4+5+6)</th>
        </tr>
        </thead>
        <tbody>
