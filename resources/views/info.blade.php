...
@section('main')
    ...
    <p>
        ...
        3.	วันที่ 21 – 25 พฤษภาคม นักเรียนทำการตอบรับการออดิชั่น<br />
    ...
    <!-- <script type="text/javascript">
        ...
        function drawChart() {
            ...
            dataTable.addRows([
                ['สมาชิกเดิมยืนยัน', 'สมาชิกเดิมยืนยัน', new Date(2019, 4, 16, 8), new Date(2019, 4, 16, 22)],
                ['ลงทะเบียนชมรมที่ไม่มีออดิชั่น', 'ลงทะเบียนชมรมที่ไม่มีออดิชั่น', new Date(2019, 4, 17, 8), new Date(2019, 4, 20, 23)],
                ['ลงทะเบียนชมรมที่มีออดิชั่น', 'ลงทะเบียนชมรมที่มีออดิชั่น', new Date(2019, 4, 17, 8), new Date(2019, 4, 20, 23)],
                ['ออดิชั่น', 'ออดิชั่น', new Date(2019, 4, 21, 8), new Date(2019, 4, 24, 23)],
                ['ตอบรับการคัดเลือก', 'ตอบรับการคัดเลือก', new Date(2019, 4, 21, 8), new Date(2019, 4, 25, 23)],
                ['เก็บตก', 'เก็บตก', new Date(2019, 4, 26, 10), new Date(2019, 4, 26, 21)]]);
    ...
    <p>
        ...
        - ชมรมที่มีการคัดเลือก แบ่งอัตราส่วนนักเรียนเป็น นักเรียนเก่าร้อยละ 65 และนักเรียนใหม่ร้อยละ 35 ของจำนวนรับสูงสุด<br />
        - ชมรมที่ไม่มีการคัดเลือก แบ่งอัตราส่วนนักเรียนเป็น นักเรียนเก่าร้อยละ 35 นักเรียนชั้นมัธยมศึกษาปีที่ 4 ร้อยละ 35 นักเรียนชั้นมัธยมศึกษาปีที่ 5 และ 6 ที่สมัครเข้ามาใหม่ร้อยละ 20 และนักเรียนที่ไม่ผ่านการคัดเลือกในรอบที่ 1 ร้อยละ 10 ของจำนวนรับสูงสุด<br />
