...
@section('main')
    ...
    <p>
        1. วันที่ 16 - 17 พฤษภาคม 2560 นักเรียนที่ต้องการเลือกชมรมเดิม ยืนยันสิทธิ์<br/>
        2. วันที่ 16 - 27 พฤษภาคม 2560 จัดการคัดเลือกนักเรียนเข้าชมรมที่ต้องมีการคัดเลือก (ออดิชั่น) โดยนักเรียนจะต้องยืนยันหรือปฏิเสธการเข้าชมรมที่นักเรียนผ่านการคัดเลือกภายในระยะเวลาดังกล่าว
        มิฉะนั้นระบบอาจยกเลิกสิทธิหรือจัดนักเรียนเข้าชมรมโดยอัตโนมัติ<br/>
        3. วันที่ 28 พฤษภาคม 2560 ตั้งแต่เวลา 10.00 น. นักเรียนลงทะเบียนเข้าชมรมที่ไม่ต้องคัดเลือก
    </p>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            dataTable.addRows([
                ['สมาชิกเดิม', 'สมาชิกเดิม', new Date(2019, 4, 16, 8), new Date(2019, 4, 17, 22)],
                ['คัดเลือก', 'คัดเลือก', new Date(2019, 4, 16, 8), new Date(2019, 4, 27, 23)],
                ['ไม่คัดเลือก', 'ไม่คัดเลือก', new Date(2019, 4, 28, 10), new Date(2019, 4, 28, 21)]]);
    ...
    <p>
        ...
        - ไม่อนุญาตให้นักเรียนที่อยู่ระหว่างลาพักการเรียนเข้าใช้ระบบ
    </p>
