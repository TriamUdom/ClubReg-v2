...
@section('main')
    ...
    <p>
        ...
        3. วันที่ 21 พฤษภาคม 2560 ตั้งแต่เวลา 10.00 น. นักเรียนลงทะเบียนเข้าชมรมที่ไม่ต้องคัดเลือก
    </p>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            dataTable.addRows([
                ...
                ['ไม่คัดเลือก', 'ไม่คัดเลือก', new Date(2017, 4, 21, 10), new Date(2017, 4, 21, 21)]]);
