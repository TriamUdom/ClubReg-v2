...
@section('main')
    ...
    <p>
        ...
        2. วันที่ 17 - 20 พฤษภาคม 2560 จัดการคัดเลือกนักเรียนเข้าชมรมที่ต้องมีการคัดเลือก (ออดิชั่น) โดยนักเรียนจะต้องยืนยันหรือปฏิเสธการเข้าชมรมที่นักเรียนผ่านการคัดเลือกภายในระยะเวลาดังกล่าว
        มิฉะนั้นระบบอาจยกเลิกสิทธิหรือจัดนักเรียนเข้าชมรมโดยอัตโนมัติ<br/>
        3. วันที่ 22 พฤษภาคม 2560 ตั้งแต่เวลา 10.00 น. นักเรียนลงทะเบียนเข้าชมรมที่ไม่ต้องคัดเลือก
    </p>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            dataTable.addRows([
                ['สมาชิกเดิม', 'สมาชิกเดิม', new Date(2018, 4, 16, 8), new Date(2018, 4, 17, 22)],
                ['คัดเลือก', 'คัดเลือก', new Date(2018, 4, 17, 8), new Date(2018, 4, 20, 23)],
                ['ไม่คัดเลือก', 'ไม่คัดเลือก', new Date(2018, 4, 22, 10), new Date(2018, 4, 22, 21)]]);
